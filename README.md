...
- <img src="http://currents.dev/favicon.ico" height="14"/> [Currents](https://github.com/currents-dev/currents-mcp) - Enable AI Agents to fix Playwright test failures reported to [Currents](https://currents.dev).
