...
- <img src="https://cdn.simpleicons.org/prisma/2D3748" height="14"/> [Prisma Postgres](https://github.com/prisma/mcp)<sup><sup>⭐</sup></sup> - Prisma Postgres MCP Server. Interact with Prisma Postgres (e.g. spin up new databases and run migrations or queries).
