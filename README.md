...
- <img src="https://simpleicons.org/icons/commitlint.svg" height="14"/> [CMD-MCP-Server](https://github.com/phialsbasement/cmd-mcp-server) - MCP server allowing any and all command execution over CMD(BE CAREFUL).
