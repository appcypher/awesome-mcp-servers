...
- <img src="https://cdn4.singleinterface.com/files/outlet/logo/346970/brand_LOGO_png.png" height="14"/> [Angel One](https://github.com/bhavesh0009/angel-one-mcp-server) - Comprehensive trading and market data server for Angel One SmartAPI with 25+ tools, portfolio management, real-time data, GTT rules, and option Greeks
