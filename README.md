...
- [Thales CipherTrust Manager MCP Server](https://github.com/sanyambassi/ciphertrust-manager-mcp-server) ⭐ 🐍 ☁️ 🏠 🐧 🪟 - MCP server for Thales CipherTrust Manager integration, enabling secure key management, cryptographic operations, and compliance monitoring through AI assistants.
- [Thales CAKM MCP Server](https://github.com/sanyambassi/thales-cdsp-cakm-mcp-server) ⭐ 🐍 ☁️ 🏠 🐧 🪟 - MCP server for Thales CDSP CAKM integration, enabling secure key management, cryptographic operations, and compliance monitoring through AI assistants for Ms SQL and Oracle Databases.
- [Thales CRDP MCP Server](https://github.com/sanyambassi/thales-cdsp-crdp-mcp-server) ⭐ 📇 ☁️ 🏠 🐧 🪟 - MCP server for Thales CipherTrust Manager RestFul Data Protection service. 
<br />
