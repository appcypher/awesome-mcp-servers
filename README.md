...
- 🐍 [Python Refactoring](https://github.com/slamer59/mcp-python-refactoring) - Educational Python refactoring assistant with guided suggestions for AI assistants. Provides step-by-step refactoring instructions without automatically modifying code.
